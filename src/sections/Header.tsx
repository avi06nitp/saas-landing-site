  ...
  return (
    <header className="sticky top-0 backdrop-blur-sm z-20">
      <div className="flex justify-center items-center py-3 bg-black text-white text-small gap-3">
        <p className="text-white/60 hidden md:block"> Stramline your workflow and boot your productivity</p>
    ...
    <div className="py-5">
      <div className="container">
        <div className="flex items-center justify-between rounded-full bg-white px-5 py-5 bg-gradient-to-br from-white to-[#EAEEFE] p-10 rounded-2xl shadow-lg border-1 border-gray-500 p-4 ">
